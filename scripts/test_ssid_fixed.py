...
def main():
    ...
    if result['authentication_status']:
        ...
        print("5. Extract the SSID from the WebSocket.io auth message (NOT from cookies)")
        print("6. The SSID is PHP serialized session data (~300+ characters), NOT a 32-char hex string")
        print("7. Look for: 42[\"auth\",{\"session\":\"[FULL_SSID_HERE]\",\"isDemo\":0,...}]")
        print("8. Example: a:4:{s:10:\"session_id\";s:32:\"...\";s:10:\"ip_address\";...}hash")
